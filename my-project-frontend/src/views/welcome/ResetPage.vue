...
<template>
  <div style="text-align: center">
    ...
    <div style="margin: 0 20px" v-if="active === 0">
      ...
      <div style="margin-top: 80px">
        <el-button @click="active++" style="width: 270px" type="warning" :plain="true">开始重置密码</el-button>
      </div>
    </div>
    <div style="margin: 0 20px" v-if="active === 1">
      ...
      <div style="margin-top: 80px">
        <el-button @click="" style="width: 270px" type="danger" :plain="true">立即重置密码</el-button>
      </div>
    </div>
  </div>
